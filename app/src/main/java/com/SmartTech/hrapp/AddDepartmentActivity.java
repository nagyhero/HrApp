...
public class AddDepartmentActivity extends MyActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // init
        eName=(EditText)findViewById(R.id.add_dep_eName);
        btnSubmit=(Button)findViewById(R.id.add_dep_btn);
