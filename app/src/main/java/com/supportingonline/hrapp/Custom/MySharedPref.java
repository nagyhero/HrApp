...
public class MySharedPref {
    ...
    public static  void  setArrayOfData(Context context, HashMap<String,String> data){
    ...
    public static void removerAfterLogout(Context context){
        setdata(context,"token","");
        setdata(context,"id","");
        setdata(context,"name","");
